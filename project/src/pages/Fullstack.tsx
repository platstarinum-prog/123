      ...
      <main>
        <section className="relative pt-32 pb-16 md:pt-40 md:pb-24 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-8">
            <p className="text-xs font-semibold uppercase tracking-[0.3em] text-gray-500 mb-4">Фуллстак розробка</p>
            <h1 className="text-[clamp(2.5rem,9vw,5.5rem)] font-bold leading-[0.95] tracking-tight text-gray-900 mb-6 break-words">
              Фуллстак <span className="text-gray-400">рішення</span>
            </h1>
        ...
        <section className="py-16 md:py-24 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-8 grid md:grid-cols-2 gap-6">
            <div className="bg-white rounded-xl p-8 border border-gray-200">
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-3">Frontend</h2>
            ...
            <div className="bg-white rounded-xl p-8 border border-gray-200">
              <div className="w-12 h-12 bg-gray-100 rounded-lg flex items-center justify-center mb-5"><Server size={22} className="text-gray-900" /></div>
              <h2 className="text-2xl font-bold text-gray-900 mb-3">Backend</h2>
        ...
        <section className="py-16 md:py-24 bg-white">
          <div className="max-w-3xl mx-auto px-4 sm:px-8">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-8">Що входить у fullstack-проєкт</h2>
        ...
        <section className="py-16 bg-gray-900 text-center">
          <div className="max-w-3xl mx-auto px-4">
            <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">Потрібен fullstack-розробник?</h2>
