    ...
    <div className="min-h-screen bg-white overflow-x-hidden">
      ...
      <main>
        <article className="pt-32 pb-16 md:pt-40 md:pb-24 max-w-3xl mx-auto px-4 sm:px-8">
          <p className="text-xs font-semibold uppercase tracking-[0.3em] text-gray-500 mb-4">Гайд · 28 квітня 2026</p>
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-10 mb-4">1. Швидкість — це гроші</h2>
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-10 mb-4">2. SEO без головного болю</h2>
          <p className="text-gray-600 leading-relaxed mb-6">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-10 mb-4">3. WordPress vs React: чесно</h2>
          <p className="text-gray-600 leading-relaxed mb-6">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-10 mb-4">4. А якщо потрібен fullstack?</h2>
          <p className="text-gray-600 leading-relaxed mb-6">
            Якщо тобі потрібен не тільки сайт, а й бекенд з базою даних — React + Node.js робить це в рамках одного стеку. Дивись сторінку <Link to="/services/fullstack" className="text-gray-900 font-semibold hover:underline">fullstack-розробки</Link>. Для магазину — <Link to="/services/ecommerce" className="text-gray-900 font-semibold hover:underline">розробка інтернет-магазину</Link>.
          </p>

          <div className="mt-12 bg-gray-50 rounded-xl p-8 text-center">
            <h3 className="text-2xl font-bold text-gray-900 mb-3">Потрібен сайт на React?</h3>
